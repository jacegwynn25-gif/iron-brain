...
export default function WorkoutMiniBar() {
    ...
    return (
        <div className="liquid-sheet-panel fixed inset-x-3 bottom-[calc(var(--iron-dock-bottom)+4.35rem)] z-[var(--z-mini-bar)] mx-auto flex max-w-2xl items-center gap-2 p-1.5">
            <button
                type="button"
